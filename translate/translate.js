...
(function () {
    ...
    * {
    ...
    var iconArray = [{
                ...
                popup: function (text) {
                    popupCenter('https://www4.bing.com/dict/search?q=' + encodeURIComponent(text), null, 800, screen.height);
                },
            ...
            },
            {
                ...
                host: ['www.bing.com', 'cn.bing.com', 'www4.bing.com'],
                popup: function (text) {
                    popupCenter('https://www4.bing.com/translator', null, 800, screen.height);
                },
                custom: function (text) {
