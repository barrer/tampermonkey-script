...
(function () {
    ...
    var iconArray = [
        ...
        },
        {
            ...
            popup: function (text) {
                popupCenter('http://dict.youdao.com/w/eng/' + encodeURIComponent(text), null, 800, screen.height);
            },
            custom: function (text) {
            }
        },
        ...
        },
        {
            ...
            popup: function (text) {
                popupCenter('http://dict.cn/' + encodeURIComponent(text), null, 800, screen.height);
            },
            custom: function (text) {
            }
        },
